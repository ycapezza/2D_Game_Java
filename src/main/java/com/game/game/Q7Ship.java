...
public class Q7Ship extends  SpaceShip {
    public Q7Ship() {
        super(85);
        weapons.add(new Poum());
        this.appearance = new Image("file:src/main/java/com/game/game/images/Q7Ship.png");
        this.laser = new Image("file:src/main/java/com/game/game/images/greenLaser.png");
        this.y1 = -100;
        this.y2 = 100;
        this.from = 100;
        this.to = -300;
