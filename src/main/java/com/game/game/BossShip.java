...
public class BossShip extends SpaceShip {
    public BossShip() {
        super(65);
        weapons.add(new Baw());
        this.appearance = new Image("file:src/main/java/com/game/game/images/BossShip.png");
        this.laser = new Image("file:src/main/java/com/game/game/images/bossLaser.png");
        this.y1 = -100;
        this.y2 = 100;
        this.from = 100;
        this.to = -300;
