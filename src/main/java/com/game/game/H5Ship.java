...
public class H5Ship extends SpaceShip {
    public H5Ship() {
        super(70);
        weapons.add(new Poum());
        this.appearance = new Image("file:src/main/java/com/game/game/images/H5Ship.png");
        this.laser = new Image("file:src/main/java/com/game/game/images/whiteLaser.png");
        this.y1 = -100;
        this.y2 = 100;
        this.from = 100;
        this.to = -300;
