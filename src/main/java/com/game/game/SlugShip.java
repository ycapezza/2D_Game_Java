...
public class SlugShip extends SpaceShip {
    public SlugShip() {
        super(80);
        weapons.add(new Poum());
        this.appearance = new Image("file:src/main/java/com/game/game/images/SlugShip.png");
        this.laser = new Image("file:src/main/java/com/game/game/images/yellowLaser.png");
        this.y1 = -100;
        this.y2 = 100;
        this.from = 280;
        this.to = -300;
